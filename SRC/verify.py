...
async def main():
    ...
    if health_ok:
        print("\n[SUCCESS] Basic verification passed! The server is running and responsive.")
        sys.exit(0)
    else:
        print("\n[WARNING] Verification failed. Please check the logs and ensure the server is running.")
        sys.exit(1)
