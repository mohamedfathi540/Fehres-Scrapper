...
def upgrade() -> None:
    ...
    if 'project_name' not in [c['name'] for c in insp.get_columns('projects')]:
    ...
    if 'user_id' not in [c['name'] for c in insp.get_columns('users')]:
    ...
    if not insp.has_table('user_usage_quotas'):
